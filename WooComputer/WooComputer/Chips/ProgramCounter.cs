...
namespace WooComputer.Chips
{
    ...
    public class ProgramCounter
    {
        ...
        public bool[] Cycle(bool[] instruction, bool load, bool increment, bool reset)
        {
            ...
            if (load && increment && reset ||  (load && increment) || (reset && load) || (load && reset)) {
            ...
            var inputOrReset = Gates.Mux(instruction, new bool[] { false, false, false, false, false, false, false, false }, reset);
            ...
            var add = Operators.Add(output, new bool[] { false, false, false, false, false, false, false, true });
